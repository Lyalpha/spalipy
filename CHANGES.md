...
## [3.5.5] 2026-03
  - Relax `sep` version constraint to `>=1.2.1`.
  - Remove `requirements.txt` in preference of `setup.py` for dependencies.
...
## [3.5.4] 2025-03
  ...
  - Remove deprecated `scipy.ndimage.interpolation` usage.
